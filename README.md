...
3. Update `build.gradle` dependency coordinates for Create and Sync if they differ from your local environment. The placeholders use the versions listed above.
